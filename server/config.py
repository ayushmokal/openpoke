...
class Settings(BaseModel):
    ...
    # LLM model selection (using Gemini)
    ...
    # Ultrahuman API
    ultrahuman_partner_api_key: Optional[str] = Field(default=os.getenv("ULTRAHUMAN_PARTNER_API_KEY"))
    ultrahuman_partner_api_url: str = Field(default=os.getenv("ULTRAHUMAN_PARTNER_API_URL", "https://partner.ultrahuman.com"))
